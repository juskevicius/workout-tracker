...
- **7 Libraries**
  ...
  - `@workout-tracker/shop-feature-products` - Product listing feature (React)
  - `@workout-tracker/shop-feature-product-detail` - Product detail feature (React)
  - `@workout-tracker/shop-data` - Data access layer for shop features
  - `@workout-tracker/shop-shared-ui` - Shared UI components
  - `@workout-tracker/models` - Shared data models
  - `@workout-tracker/bff-products` - API product service library
  - `@workout-tracker/shared-test-utils` - Shared testing utilities
